...
namespace ResellerQuotationSystem.SYS.Admin
{
    public class UserMaster
    {
        public static void createTable()
        {
            ...
            AxtCRUD.createTable("SYS.Admin.UserMaster.createUserMaster", queryParams);
        }

        public static string getUserMaster()
        {
            if (AxtLoginCheck.isLogin() == false)
            {
                return null;
            ...
            Hashtable queryParams = new Hashtable();
            return AxtCRUD.readJson("SYS.Admin.UserMaster.getUserMaster", queryParams, "UserMaster");
        }
        ...
        public static string saveData(ArrayList newData)
        {
            ...
            for (int i = 0, len = newData.Count; i < len; ++i)
            {
                ...
                if (null == data["SID"] || "" == data["SID"])
                {
                    ...
                    AxtCRUD.insert("SYS.Admin.UserMaster.addData", data);
        ...
        public static void update(Hashtable data)
        {
            ...
            AxtCRUD.update("SYS.Admin.UserMaster.updateData", data);
        ...
        public static void deleteAll()
        {
            ...
            Hashtable queryParams = new Hashtable();
            AxtCRUD.delete("SYS.Admin.UserMaster.deleteAll", queryParams);
        }
        ...
        public static string deleteData(ArrayList deleteData)
        {
            ...
            for (int i = 0, len = deleteData.Count; i < len; ++i)
            {
                ...
                if (null != data["SID"] && "" != data["SID"])
                {
                    AxtCRUD.delete("SYS.Admin.UserMaster.deleteData", data);
