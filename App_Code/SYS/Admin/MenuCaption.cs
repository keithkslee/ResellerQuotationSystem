...
namespace ResellerQuotationSystem.SYS.Admin
{
    public class MenuCaption
    {
        public static void createTable()
        {
            ...
            AxtCRUD.createTable("SYS.Admin.MenuCaption.createMenuCaption", queryParams);
        }
        ...
        public static string getMenuCaption()
        {
            ...
            Hashtable queryParams = new Hashtable();
            return AxtCRUD.readJson("SYS.Admin.MenuCaption.getMenuCaption", queryParams, "MenuCaption");
        }
        ...
        public static string saveData(ArrayList newData)
        {
            ...
            for (int i = 0, len = newData.Count; i < len; ++i)
            {
                ...
                if (null == data["SID"] || "" == data["SID"])
                {
                    ...
                    AxtCRUD.insert("SYS.Admin.MenuCaption.addData", data);
        ...
        public static void update(Hashtable data)
        {
            ...
            AxtCRUD.update("SYS.Admin.MenuCaption.updateData", data);
        ...
        public static void deleteAll()
        {
            ...
            Hashtable queryParams = new Hashtable();
            AxtCRUD.delete("SYS.Admin.MenuCaption.deleteAll", queryParams);
        }
        ...
        public static string deleteData(ArrayList deleteData)
        {
            ...
            for (int i = 0, len = deleteData.Count; i < len; ++i)
            {
                ...
                if (null != data["SID"] && "" != data["SID"])
                {
                    AxtCRUD.delete("SYS.Admin.MenuCaption.deleteData", data);
