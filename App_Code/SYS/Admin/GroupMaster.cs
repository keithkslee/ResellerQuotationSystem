...
namespace ResellerQuotationSystem.SYS.Admin
{
    public class GroupMaster
    {
        public static void createTable()
        {
            ...
            AxtCRUD.createTable("SYS.Admin.GroupMaster.createGroupMaster", queryParams);
        }

        public static string getGroupMaster()
        {
            if (AxtLoginCheck.isLogin() == false)
            {
                return null;
            ...
            Hashtable queryParams = new Hashtable();
            return AxtCRUD.readJson("SYS.Admin.GroupMaster.getGroupMaster", queryParams, "GroupMaster");
        }
        ...
        public static string saveData(ArrayList newData)
        {
            ...
            for (int i = 0, len = newData.Count; i < len; ++i)
            {
                ...
                if (null == data["SID"] || "" == data["SID"])
                {
                    ...
                    AxtCRUD.insert("SYS.Admin.GroupMaster.addData", data);
        ...
        public static void update(Hashtable data)
        {
            ...
            AxtCRUD.update("SYS.Admin.GroupMaster.updateData", data);
        ...
        public static void deleteAll()
        {
            ...
            Hashtable queryParams = new Hashtable();
            AxtCRUD.delete("SYS.Admin.GroupMaster.deleteAll", queryParams);
        }
        ...
        public static string deleteData(ArrayList deleteData)
        {
            ...
            for (int i = 0, len = deleteData.Count; i < len; ++i)
            {
                ...
                if (null != data["SID"] && "" != data["SID"])
                {
                    AxtCRUD.delete("SYS.Admin.GroupMaster.deleteData", data);
