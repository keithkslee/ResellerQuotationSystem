...
namespace ResellerQuotationSystem.SYS.Admin
{
    public class ClassCaption
    {
        public static void createTable()
        {
            ...
            AxtCRUD.createTable("SYS.Admin.ClassCaption.createClassCaption", queryParams);
        }

        public static string getClassCaption()
        {
            if (AxtLoginCheck.isLogin() == false)
            {
                return null;
            ...
            Hashtable queryParams = new Hashtable();
            return AxtCRUD.readJson("SYS.Admin.ClassCaption.getClassCaption", queryParams, "ClassCaption");
        }
        ...
        public static string saveData(ArrayList newData)
        {
            ...
            for (int i = 0, len = newData.Count; i < len; ++i)
            {
                ...
                if (null == data["SID"] || "" == data["SID"])
                {
                    ...
                    AxtCRUD.insert("SYS.Admin.ClassCaption.addData", data);
        ...
        public static void update(Hashtable data)
        {
            ...
            AxtCRUD.update("SYS.Admin.ClassCaption.updateData", data);
        ...
        public static void deleteAll()
        {
            ...
            Hashtable queryParams = new Hashtable();
            AxtCRUD.delete("SYS.Admin.ClassCaption.deleteAll", queryParams);
        }
        ...
        public static string deleteData(ArrayList deleteData)
        {
            ...
            for (int i = 0, len = deleteData.Count; i < len; ++i)
            {
                ...
                if (null != data["SID"] && "" != data["SID"])
                {
                    AxtCRUD.delete("SYS.Admin.ClassCaption.deleteData", data);
