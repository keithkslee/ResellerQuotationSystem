...
namespace ResellerQuotationSystem.SYS.Admin
{
    public class UserAttribute
    {
        public static void createTable()
        {
            ...
            AxtCRUD.createTable("SYS.Admin.UserAttribute.createUserAttribute", queryParams);
        }
        ...
        public static string getUserAttribute()
        {
            ...
            Hashtable queryParams = new Hashtable();
            return AxtCRUD.readJson("SYS.Admin.UserAttribute.getUserAttribute", queryParams, "UserAttribute");
        }
        ...
        public static string saveData(ArrayList newData)
        {
            ...
            for (int i = 0, len = newData.Count; i < len; ++i)
            {
                ...
                if (null == data["SID"] || "" == data["SID"])
                {
                    ...
                    AxtCRUD.insert("SYS.Admin.UserAttribute.addData", data);
        ...
        public static void update(Hashtable data)
        {
            ...
            AxtCRUD.update("SYS.Admin.UserAttribute.updateData", data);
        ...
        public static void deleteAll()
        {
            ...
            Hashtable queryParams = new Hashtable();
            AxtCRUD.delete("SYS.Admin.UserAttribute.deleteAll", queryParams);
        }
        ...
        public static string deleteData(ArrayList deleteData)
        {
            ...
            for (int i = 0, len = deleteData.Count; i < len; ++i)
            {
                ...
                if (null != data["SID"] && "" != data["SID"])
                {
                    AxtCRUD.delete("SYS.Admin.UserAttribute.deleteData", data);
