...
{
    public class reseller_quotation_report
    {
        public static void createTable()
        {
            ...
            AxtCRUD.createTable("ResellerQuotationSystem.reseller_quotation_report.createreseller_quotation_report", queryParams);
            AxtCRUD.createTable("ResellerQuotationSystem.reseller_quotation_report.createreseller_quotation_reportHistory", queryParams);
        }

        public static string getreseller_quotation_report(Hashtable queryParams)
        {
            if (AxtLoginCheck.isLogin() == false)
            {
                return null;
            ...
            Hashtable totalCount = (Hashtable)Mapper.Instance().QueryForObject("ResellerQuotationSystem.reseller_quotation_reportgetreseller_quotation_reportTotalCount", queryParams);
            return AxtCRUD.readJson("ResellerQuotationSystem.reseller_quotation_report.getreseller_quotation_report", queryParams, "reseller_quotation_report", totalCount["NUM"].ToString());
        }
        ...
        public static string saveData(ArrayList newData)
        {
            ...
            for (int i = 0, len = newData.Count; i < len; ++i)
            {
                ...
                if (null == data["SID"] || "" == data["SID"])
                {
                    ...
                    AxtCRUD.insert("ResellerQuotationSystem.reseller_quotation_report.addData", data);
            ...
            setspecification4_v();
            setquantity4_v();
            setone_year_value4_v();
            setone_year_price4_v();
            setthree_year_value4_v();
            setthree_year_price4_v();
        ...
        public static void update(Hashtable data)
        {
            ...
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.updateData", data);
        ...
        public static void setreporttitle_v()
        {
            ...
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setreporttitle_v", data);
        }
        ...
        public static void setreportname_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setreportname_v", data);
        }
        ...
        public static void setresellername_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setresellername_v", data);
        }
        ...
        public static void setquotationno_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setquotationno_v", data);
        }
        ...
        public static void setunifiednumbering_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setunifiednumbering_v", data);
        }
        ...
        public static void setquote_date_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setquote_date_v", data);
        }
        ...
        public static void setcompact_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setcompact_v", data);
        }
        ...
        public static void setship_date_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setship_date_v", data);
        }
        ...
        public static void setemail_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setemail_v", data);
        }
        ...
        public static void setpayment_conditions_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setpayment_conditions_v", data);
        }
        ...
        public static void setphone_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setphone_v", data);
        }
        ...
        public static void setcompetitivebrands_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setcompetitivebrands_v", data);
        }
        ...
        public static void setfax_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setfax_v", data);
        }
        ...
        public static void setcustomername_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setcustomername_v", data);
        }
        ...
        public static void setaddress_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setaddress_v", data);
        }
        ...
        public static void setordertype_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setordertype_v", data);
        }
        ...
        public static void setdeliveryaddress_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setdeliveryaddress_v", data);
        }
        ...
        public static void setofferors_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setofferors_v", data);
        }
        ...
        public static void setitem1_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setitem1_v", data);
        }
        ...
        public static void setproduct_name1_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setproduct_name1_v", data);
        }
        ...
        public static void setspecification1_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setspecification1_v", data);
        }
        ...
        public static void setquantity1_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setquantity1_v", data);
        }
        ...
        public static void setoneyearvalue1_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setoneyearvalue1_v", data);
        }
        ...
        public static void setone_year_price1_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setone_year_price1_v", data);
        }
        ...
        public static void setthreeyearvalue1_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setthreeyearvalue1_v", data);
        }
        ...
        public static void setthree_year_price1_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setthree_year_price1_v", data);
        }
        ...
        public static void setitem2_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setitem2_v", data);
        }
        ...
        public static void setproduct_name2_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setproduct_name2_v", data);
        }
        ...
        public static void setspecification2_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setspecification2_v", data);
        }
        ...
        public static void setquantity2_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setquantity2_v", data);
        }
        ...
        public static void setoneyearvalue2_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setoneyearvalue2_v", data);
        }
        ...
        public static void setone_year_price2_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setone_year_price2_v", data);
        }
        ...
        public static void setthreeyearvalue2_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setthreeyearvalue2_v", data);
        }
        ...
        public static void setthree_year_price2_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setthree_year_price2_v", data);
        }
        ...
        public static void setitem3_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setitem3_v", data);
        }
        ...
        public static void setproduct_name3_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setproduct_name3_v", data);
        }
        ...
        public static void setspecification3_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setspecification3_v", data);
        }
        ...
        public static void setquantity3_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setquantity3_v", data);
        }
        ...
        public static void setoneyearvalue3_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setoneyearvalue3_v", data);
        }
        ...
        public static void setone_year_price3_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setone_year_price3_v", data);
        }
        ...
        public static void setthreeyearvalue3_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setthreeyearvalue3_v", data);
        }
        ...
        public static void setthree_year_price3_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setthree_year_price3_v", data);
        }

        public static void setitem4_v()
        {
            if (AxtLoginCheck.isLogin() == false)
            {
                return;
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setitem4_v", data);
        }

        public static void setproduct_name4_v()
        {
            if (AxtLoginCheck.isLogin() == false)
            {
                return;
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setproduct_name4_v", data);
        }

        public static void setspecification4_v()
        {
            if (AxtLoginCheck.isLogin() == false)
            {
                return;
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setspecification4_v", data);
        }

        public static void setquantity4_v()
        {
            if (AxtLoginCheck.isLogin() == false)
            {
                return;
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setquantity4_v", data);
        }

        public static void setone_year_value4_v()
        {
            if (AxtLoginCheck.isLogin() == false)
            {
                return;
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setone_year_value4_v", data);
        }

        public static void setone_year_price4_v()
        {
            if (AxtLoginCheck.isLogin() == false)
            {
                return;
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setone_year_price4_v", data);
        }

        public static void setthree_year_value4_v()
        {
            if (AxtLoginCheck.isLogin() == false)
            {
                return;
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setthree_year_value4_v", data);
        }

        public static void setthree_year_price4_v()
        {
            if (AxtLoginCheck.isLogin() == false)
            {
                return;
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setthree_year_price4_v", data);
        }
        ...
        public static void setnoamounttaxvalueyear_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setnoamounttaxvalueyear_v", data);
        }
        ...
        public static void setno_amount_tax_year_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setno_amount_tax_year_v", data);
        }
        ...
        public static void setnoamounttaxvaluetriennial_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setnoamounttaxvaluetriennial_v", data);
        }
        ...
        public static void setno_tax_amount_triennial_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setno_tax_amount_triennial_v", data);
        }
        ...
        public static void setoneyearsalestaxvalue_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setoneyearsalestaxvalue_v", data);
        }
        ...
        public static void setone_year_sales_tax_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setone_year_sales_tax_v", data);
        }
        ...
        public static void setthreeyearsalestaxvalue_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setthreeyearsalestaxvalue_v", data);
        }
        ...
        public static void setthree_year_sales_tax_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setthree_year_sales_tax_v", data);
        }
        ...
        public static void settotalvalueyear_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.settotalvalueyear_v", data);
        }
        ...
        public static void settotal_year_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.settotal_year_v", data);
        }
        ...
        public static void settotalthreeyearvalueperiod_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.settotalthreeyearvalueperiod_v", data);
        }
        ...
        public static void settotal_three_year_period_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.settotal_three_year_period_v", data);
        }
        ...
        public static void setnote_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setnote_v", data);
        }
        ...
        public static void sethead_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.sethead_v", data);
        }
        ...
        public static void setsales_manager_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setsales_manager_v", data);
        }
        ...
        public static void setattn_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setattn_v", data);
        }
        ...
        public static void setcustomers_sign_v()
        {
            ...
            Hashtable data = new Hashtable();
            AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.setcustomers_sign_v", data);
        }
        ...
        public static void deleteAll()
        {
            ...
            Hashtable queryParams = new Hashtable();
            AxtCRUD.delete("ResellerQuotationSystem.reseller_quotation_report.deleteAll", queryParams);
        }
        ...
        public static string deleteData(ArrayList deleteData)
        {
            ...
            for (int i = 0, len = deleteData.Count; i < len; ++i)
            {
                ...
                if (null != data["SID"] && "" != data["SID"])
                {
                    AxtCRUD.delete("ResellerQuotationSystem.reseller_quotation_report.deleteData", data);
        ...
        public static string getreseller_quotation_reportBy(Hashtable queryParams)
        {
            if (AxtLoginCheck.isLogin() == false)
            {
                return null;
            ...
            Hashtable totalCount = (Hashtable)Mapper.Instance().QueryForObject("ResellerQuotationSystem.reseller_quotation_report.getreseller_quotation_reportByTotalCount", queryParams);
            return  AxtCRUD.readJson("ResellerQuotationSystem.reseller_quotation_report.getreseller_quotation_reportBy", queryParams, "reseller_quotation_report", totalCount["NUM"].ToString());
		...
		try{
            ...
            String File_Input = HttpContext.Current.Server.MapPath("~/") + "Report_Input\\ResellerQuotationSystemResellerQuotationSystem_report.dot";
            ...
            String item4_v = "";
            String product_name4_v = "";
            String specification4_v = "";
            String quantity4_v = "";
            String one_year_value4_v = "";
            String one_year_price4_v = "";
            String three_year_value4_v = "";
            String three_year_price4_v = "";
            ...
            for (int i = 0; i < datas.Count; ++i)
            {
            		...
            		String report_title = "reseller_quotation_report";
					...
					three_year_price3_v = data["THREE_YEAR_PRICE3_V"].ToString();
              		...
              		if( data["ITEM4_V"] != null)
              		{
              			axtReport.GotoBookMark("Item4");
					item4_v = data["ITEM4_V"].ToString();
              			axtReport.InsertText(item4_v);
              		}
              		if( data["PRODUCT_NAME4_V"] != null)
              		{
              			axtReport.GotoBookMark("ProductName4");
					product_name4_v = data["PRODUCT_NAME4_V"].ToString();
              			axtReport.InsertText(product_name4_v);
              		}
              		if( data["SPECIFICATION4_V"] != null)
              		{
              			axtReport.GotoBookMark("Specification4");
					specification4_v = data["SPECIFICATION4_V"].ToString();
              			axtReport.InsertText(specification4_v);
              		}
              		if( data["QUANTITY4_V"] != null)
              		{
              			axtReport.GotoBookMark("Quantity4");
					quantity4_v = data["QUANTITY4_V"].ToString();
              			axtReport.InsertText(quantity4_v);
              		}
              		if( data["ONE_YEAR_VALUE4_V"] != null)
              		{
              			axtReport.GotoBookMark("OneYearValue4");
					one_year_value4_v = data["ONE_YEAR_VALUE4_V"].ToString();
              			axtReport.InsertText(one_year_value4_v);
              		}
              		if( data["ONE_YEAR_PRICE4_V"] != null)
              		{
              			axtReport.GotoBookMark("OneYearPrice4");
					one_year_price4_v = data["ONE_YEAR_PRICE4_V"].ToString();
              			axtReport.InsertText(one_year_price4_v);
              		}
              		if( data["THREE_YEAR_VALUE4_V"] != null)
              		{
              			axtReport.GotoBookMark("ThreeYearValue4");
					three_year_value4_v = data["THREE_YEAR_VALUE4_V"].ToString();
              			axtReport.InsertText(three_year_value4_v);
              		}
              		if( data["THREE_YEAR_PRICE4_V"] != null)
              		{
              			axtReport.GotoBookMark("ThreeYearPrice4");
					three_year_price4_v = data["THREE_YEAR_PRICE4_V"].ToString();
              			axtReport.InsertText(three_year_price4_v);
              		}
            ...
            String file_output = HttpContext.Current.Server.MapPath("~/") + "Report_Output\\ResellerQuotationSystemResellerQuotationSystem_report.";
        ...
        public static string saveStatus(string work_event,string status)
        {
            ...
            Hashtable totalCount = (Hashtable) Mapper.Instance().QueryForObject("ResellerQuotationSystem.reseller_quotation_report.getWork_event",queryParams);
                if (totalCount == null )
                {
                    data["SID"] = AxtLibrary.GetUniqueKey(18);
                    AxtCRUD.insert("ResellerQuotationSystem.reseller_quotation_report.addStatus",data);
                }
                else
                {
                    data["SID"] = AxtLibrary.GetUniqueKey(18);
                    AxtCRUD.update("ResellerQuotationSystem.reseller_quotation_report.updateStatus",data);
                }
            return "ANS_00003";
        }
        /*user code start*/
    ...
    public static void sendEmail(String file_output, String fileFormat, Hashtable Data){
    		...
    		ArrayList datas = AxtCRUD.read("ResellerQuotationSystem.reseller_quotation_report.getEmailSetting", queryData);
