...
{
    public class reseller_shipper_input
    {
        public static void createTable()
        {
            ...
            AxtCRUD.createTable("ResellerQuotationSystem.reseller_shipper_input.createreseller_shipper_input", queryParams);
            AxtCRUD.createTable("ResellerQuotationSystem.reseller_shipper_input.createreseller_shipper_inputHistory", queryParams);
        }

        public static string getreseller_shipper_input(Hashtable queryParams)
        {
            if (AxtLoginCheck.isLogin() == false)
            {
                return null;
            ...
            Hashtable totalCount = (Hashtable)Mapper.Instance().QueryForObject("ResellerQuotationSystem.reseller_shipper_inputgetreseller_shipper_inputTotalCount", queryParams);
            return AxtCRUD.readJson("ResellerQuotationSystem.reseller_shipper_input.getreseller_shipper_input", queryParams, "reseller_shipper_input", totalCount["NUM"].ToString());
        }
        ...
        public static string saveData(ArrayList newData)
        {
            ...
            for (int i = 0, len = newData.Count; i < len; ++i)
            {
                ...
                if (null == data["SID"] || "" == data["SID"])
                {
                    ...
                    AxtCRUD.insert("ResellerQuotationSystem.reseller_shipper_input.addData", data);
        ...
        public static void update(Hashtable data)
        {
            ...
            AxtCRUD.update("ResellerQuotationSystem.reseller_shipper_input.updateData", data);
        ...
        public static void deleteAll()
        {
            ...
            Hashtable queryParams = new Hashtable();
            AxtCRUD.delete("ResellerQuotationSystem.reseller_shipper_input.deleteAll", queryParams);
        }
        ...
        public static string deleteData(ArrayList deleteData)
        {
            ...
            for (int i = 0, len = deleteData.Count; i < len; ++i)
            {
                ...
                if (null != data["SID"] && "" != data["SID"])
                {
                    AxtCRUD.delete("ResellerQuotationSystem.reseller_shipper_input.deleteData", data);
        ...
        public static string getreseller_shipper_inputBy(Hashtable queryParams)
        {
            if (AxtLoginCheck.isLogin() == false)
            {
                return null;
            ...
            Hashtable totalCount = (Hashtable)Mapper.Instance().QueryForObject("ResellerQuotationSystem.reseller_shipper_input.getreseller_shipper_inputByTotalCount", queryParams);
            return  AxtCRUD.readJson("ResellerQuotationSystem.reseller_shipper_input.getreseller_shipper_inputBy", queryParams, "reseller_shipper_input", totalCount["NUM"].ToString());
        ...
        public static string saveStatus(string work_event,string status)
        {
            ...
            Hashtable totalCount = (Hashtable) Mapper.Instance().QueryForObject("ResellerQuotationSystem.reseller_shipper_input.getWork_event",queryParams);
                if (totalCount == null )
                {
                    data["SID"] = AxtLibrary.GetUniqueKey(18);
                    AxtCRUD.insert("ResellerQuotationSystem.reseller_shipper_input.addStatus",data);
                }
                else
                {
                    data["SID"] = AxtLibrary.GetUniqueKey(18);
                    AxtCRUD.update("ResellerQuotationSystem.reseller_shipper_input.updateStatus",data);
                }
            return "ANS_00003";
        }
        /*user code start*/
